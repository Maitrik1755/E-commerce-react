...
const Navbar = () => {
  ...
  return (
    <>
      <header className='sticky top-0 bg-gray-950/95 z-50 backdrop-blur-md text-white shadow-2xl shadow-gray-950/70 border-b border-orange-900'>
        <div className='container mx-auto flex items-center justify-between py-4 px-4'>
          <Link to={'/'} >
          <div className='flex items-center space-x-3 cursor-pointer'>

            <House className='w-8 h-8 text-orange-400 drop-shadow-lg ' />
            <h1 className='text-4xl font-extrabold tracking-widest uppercase'>PATEL<span className='text-orange-400'>STORE</span></h1>
          </div>
          </Link>
          <nav className='flex items-center space-x-6'>
           ...
           <ShoppingCart className='w-6 h-6 text-orange-400 drop-shadow-lg ' />
